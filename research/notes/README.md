...
This directory holds written findings extracted from the upstream clones and from papers.

Each note should be grounded in a real source:

- local upstream checkout under `../upstream/`
- official docs
- a paper or benchmark source
